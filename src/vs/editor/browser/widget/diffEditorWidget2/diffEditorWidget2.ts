...
import { ObservableElementSizeObserver, animatedObservable, applyObservableDecorations } from 'vs/editor/browser/widget/diffEditorWidget2/utils';
...
export class DiffEditorWidget2 extends DelegatingEditor implements IDiffEditor {
	...
	private readonly _viewZoneAlignment: ViewZoneAlignment;
	...
	constructor(
		...
		this._viewZoneAlignment = this._register(new ViewZoneAlignment(this._originalEditor, this._modifiedEditor, this._diffModel));
		...
		/*
				...
				this._register(autorun('update', reader => {
					...
					// TODO: Do this after the viewzones got updated and don't use setTimeout
					...
					this._viewZoneAlignment.alignLines(scrollTopDelta);
